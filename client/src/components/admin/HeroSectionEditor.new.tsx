...
const heroFormSchema = z.object({
  mediaUrl: z
    ...
    .refine((url) => url.includes("youtube.com") || url.includes("youtu.be") || /\.(mp4|webm|ogg|mov)$/i.test(url), {
      message: "URL must be a YouTube video or a direct video file (mp4, webm, ogg, mov)",
    }),
...
export default function HeroSectionEditor() {
  ...
  const getResolutionInfo = () => {
    ...
    if (mediaUrl.includes("youtube.com") || mediaUrl.includes("youtu.be")) {
      return "YouTube videos automatically adapt to viewport size. For optimal quality, use a video with 1080p (1920×1080) resolution.";
    }
    
    return "For optimal performance, use a video with 1080p (1920×1080) resolution and size under 50MB.";
  };
          ...
          <Alert className="bg-blue-50 border-blue-200">
            ...
            <AlertDescription className="text-blue-700">
              ...
              <ul className="list-disc list-inside mt-2 text-sm">
                <li><strong>Portrait mode videos</strong> are recommended for mobile-first design (9:16 ratio)</li>
                <li>Landscape videos (16:9) are also supported</li>
                <li>For YouTube videos, use the standard watch URL or short URL</li>
