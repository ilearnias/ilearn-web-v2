  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "primary-red-hover": "rgb(var(--primary-red-hover) / <alpha-value>)",
        "primary-blue": "rgb(var(--primary-blue) / <alpha-value>)",
        "primary-blue-hover": "rgb(var(--primary-blue-hover) / <alpha-value>)",
      ...
      animation: {
        ...
        "highlightLeftToRight": "highlight-left-to-right 1.5s ease-in-out forwards",
      },
    },
  },
